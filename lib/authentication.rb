module Authentication
  mattr_accessor :login_regex, :bad_login_message, 
    ...
    :email_name_regex, :domain_head_regex, :domain_tld_regex, :email_regex, :email_slice_regex, :bad_email_message
  ...
  self.email_slice_regex = /#{email_name_regex}@#{domain_head_regex}#{domain_tld_regex}/i
  self.email_regex       = /\A#{email_slice_regex.source}\z/i
